...
<body class="bg-light"><!--navbar-->
    ...
    <div class="container">
        <div class="row">
         ...
         <div class="col-lg-12 text-center mt-5">
             <a href="rooms_page.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">More Rooms >>></a>
         </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
            ...
            <div class="col-lg-12 text-center mt-5">
                <a href="facilities_page.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">More Facilities >>></a>
            </div>
        </div>
    </div>

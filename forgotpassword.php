<?php
    ...
    {   
        ...
        try 
        {
            ...
            $mail->Subject = 'Password Reset Link from Floris31 Resort';
            $mail->Body    = "We got a request from you to reset your password!<br>
                            Click the link below:<br>
                            <a href='http://localhost/floris31website/updatepassword.php?email=$email&reset_token=$reset_token'>Reset Password</a>";

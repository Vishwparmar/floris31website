                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input name="area" min="1" type="number" class="form-control" required>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input name="adult" min="1" type="number" class="form-control" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Children (Max.) </label>
                            <input name="children" min="1" type="number" class="form-control" required>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="border-bottom border-3 pb-3 mb-3">
                        <form id="add_image_form">
                            ...
                            <input name="image" accept=".jpg, .png, .jpeg, .webp" type="file" class="form-control mb-3" required>
        ...
        function add_image() 
        {
            ...
            xhr.onload = function ()
            {
                ...
                if (this.responseText == "inv_img") {
                    alert('error', 'Only JPEG WEBP or PNG images are allowed!','image-alert');
                } 

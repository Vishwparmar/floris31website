<?php
    ...
    if(isset($_GET['fetch_rooms']))
    {
        ...
        //count no of rooms and output variable to store
        $count_rooms = 0;
        $output = "";

        //fetching settings table to check shutdown or not
        ...
        while($room_data = mysqli_fetch_assoc($room_res))
        {
            ...
            if(!$settings_r['shutdown'])
            {
                ...
                $book_btn = "<button onclick='chechLoginToBook($login,$room_data[id])' class='btn btn-sm w-10'></button>";
            }
